        ...
        {{-- <form action="#" method="POST" id="wizard" autocomplete="off" class="relative"> --}}
            <div id="page1" class="relative grid md:grid-rows-1 grid-rows-2 md:grid-cols-2 grid-cols-1 pb-8 md:pb-24">
                <div class="pb-6">
                    ...
                    <input type="hidden" id="{{ $kyc_edit }}_kyc">
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.full_name' ) }} <span class="text-[#f00]">*</span></label>
                        <input type="text" id="{{ $kyc_edit }}_fullname"  name="full_name" placeholder="{{ __( 'member.enter' ) }}{{ __( 'member.full_name' ) }}" class="w-full form-control" required readonly>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.id_number' ) }} <span class="text-[#f00]">*</span></label>
                        <input type="text" id="{{ $kyc_edit }}_identification_number"  id="{{ $kyc_edit }}_identification_number" name="id_number" placeholder="{{ __( 'member.enter' ) }}{{ __( 'member.id_number' ) }}" class="w-full form-control" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.dob' ) }} <span class="text-[#f00]">*</span></label>
                        <input type="date" id="{{ $kyc_edit }}_date_of_birth" name="dob" placeholder="{{ __( 'member.enter' ) }}{{ __( 'member.dob' ) }}" class="w-full form-control" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.residential_address' ) }} <span class="text-[#f00]">*</span></label>
                        <textarea name="address" id="{{ $kyc_edit }}_address" placeholder="{{ __( 'member.enter' ) }}{{ __( 'member.residential_address' ) }}" class="w-full form-control" required></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="md:border-l border-solid border-[#EDEDED]">
                    ...
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.full_name' ) }}</label>
                        <input type="text" id="{{ $kyc_edit }}_beneficiary_fullname" name="bene_full_name" placeholder="{{ __( 'member.enter' ) }}{{ __('member.beneficiary') }} {{ __( 'member.full_name' ) }}" class="w-full form-control">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.id_number' ) }}</label>
                        <input type="text" id="{{ $kyc_edit }}_beneficiary_identification_number" name="bene_id_number" placeholder="{{ __( 'member.enter' ) }}{{ __('member.beneficiary') }} {{ __( 'member.id_number' ) }}" class="w-full form-control">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.contact_number' ) }}</label>
                        <input type="text" id="{{ $kyc_edit }}_contact_number" name="bene_phone_number" placeholder="{{ __( 'member.enter' ) }}{{ __('member.contact_number') }}" class="w-full form-control">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            ...
            <div class="relative grid md:grid-rows-1 grid-rows-2 md:grid-cols-2 grid-cols-1 pb-4 hidden auto-rows-auto" id="page2">
                <div class="pb-6">
                    ...
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.choose_bank' ) }} <span class="text-[#f00]">*</span></label>
                        <select class="form-select" id="{{ $kyc_edit }}_bank" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'user_kyc.bank' ) ] ) }}">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.account_holder_name' ) }} <span class="text-[#f00]">*</span></label>
                        <input type="text" id="{{ $kyc_edit }}_account_holder_name" name="bene_id_number" placeholder="{{ __( 'member.enter' ) }}{{ __('member.account_holder_name') }}" class="w-full form-control" required readonly>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="px-4 py-2">
                        <label class="text-[12px] text-[#A1A5B7]" for="full_name">{{ __( 'member.account_number' ) }} <span class="text-[#f00]">*</span></label>
                        <input type="text" id="{{ $kyc_edit }}_account_number" name="bene_phone_number" placeholder="{{ __( 'member.enter' ) }}{{ __('member.account_number') }}" class="w-full form-control" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="border-t md:border-t-[0] border-solid border-[#EDEDED] md:border-l mb-[150px] md:mb-12">
                    ...
                    <div class="px-4 py-2">
                        ...
                        <div class="dropzone py-6 flex justify-center items-center w-full bg-[#F5F8FA] relative cursor-pointer" id="{{ $kyc_edit }}_ic_front" style="min-height: 0px; border:none">
                    ...
                    {{-- <div class="px-4 py-2">
                        ...
                        <div class="dropzone py-6 flex justify-center items-center w-full bg-[#F5F8FA] relative cursor-pointer" id="{{ $kyc_edit }}_ic_back" style="min-height: 0px; border:none">
                            <div class="dz-message needsclick">
                ...
                <div class="absolute left-0 right-0 mx-auto bottom-12 md:bottom-[unset] md:relative col-span-2 flex flex-col justify-center items-center gap-2">
                    <button id="{{ $kyc_edit }}_submit" class="primary_btn transition w-full mt-6 mx-auto max-w-[250px] min-w-[120px]" value="{{ __( 'member.update' ) }}">{{ __( 'member.update' ) }}</button>
...
<script>
    document.addEventListener( 'DOMContentLoaded', () => {
        ...
        function getUserKyc() {
            ...
            $.ajax( {
                ...
                success: function( response ) {
                    ...
                    $( kyce + '_kyc' ).val( response.encrypted_id );
                    $( kyce + '_fullname' ).val( response.fullname );
                    $( kyce + '_identification_number' ).val( response.identification_number );
                    $( kyce + '_date_of_birth' ).val( response.date_of_birth );
                    $( kyce + '_address' ).html( response.address )

                    if ( response.user_beneficiary ) {
                        $( kyce + '_beneficiary_fullname' ).val( response.user_beneficiary.fullname )
                        $( kyce + '_beneficiary_identification_number' ).val( response.user_beneficiary.identification_number )
                        $( kyce + '_contact_number' ).val( response.user_beneficiary.phone_number )
                    }

                    //page 2
                    if ( response.user_bank ) {
                        let option1 = new Option( response.user_bank.bank.name, response.user_bank.bank.id, true, true );
                        bankSelect2.append( option1 );
                        bankSelect2.trigger( 'change' );
                        $( kyce + '_account_holder_name' ).val( response.user_bank.account_holder_name );
                        $( kyce + '_account_number' ).val( response.user_bank.account_number );
                    }

                    let imagePath = null;
                    let imagePath2 = null;

                    if( response.user_kyc_documents ){
                        documents = response.user_kyc_documents;
                        ...
                        documents.forEach( function( document ) {
                            if ( document.document_type === 1 ) {
                                ...
                                fileID2 = document.file;
                                imagePath2 = document.path;
                            }
                        });
                    }
                    ...
                    Dropzone.autoDiscover = false;
                    var fileExtension = '';
                    var pdfImagePath = '{{ asset( 'member/element/pdf.png' ) }}';

                    const dropzone = new Dropzone( kyce + '_ic_front', { 
                        ...
                        init: function() {
                            if ( imagePath ) {
                                ...
                                fileExtension = imagePath.slice( ( Math.max( 0, imagePath.lastIndexOf( "." ) ) || Infinity) + 1 ).toLowerCase();

                                if (fileExtension === 'pdf') {
                                    myDropzone.displayExistingFile( mockFile, pdfImagePath );
                                } else {
                    ...
                    // const dropzone2 = new Dropzone( kyce + '_ic_back', { 
                    //     url: '{{ route( 'member.file.upload' ) }}',
                    //     maxFiles: 1,
                    //     acceptedFiles: 'image/jpg,image/jpeg,image/png,application/pdf',
                    //     addRemoveLinks: true,
                    ...
                    //             myDropzone.files.push( mockFile );
                    //             fileExtension = imagePath2.slice( ( Math.max( 0, imagePath2.lastIndexOf( "." ) ) || Infinity) + 1 ).toLowerCase();

                    //             if (fileExtension === 'pdf') {
                    //                 myDropzone.displayExistingFile( mockFile, pdfImagePath );
                    //             } else {
                    //                 myDropzone.displayExistingFile( mockFile, imagePath2 );
                    //             }
                    //         }
                    //     },
                    //     removedfile: function( file ) {
                    ...
                    $( '#modal_subject' ).html( `{{ __( 'member.failed_x', [ 'title' => Str::singular( __( 'member.user_kycs' ) ) ] ) }}` );
        ...
        $(".next-button").on("click", function () {
            ...
            formData.append( 'fullname', $( kyce + '_fullname' ).val() );
            formData.append( 'identification_number', $( kyce + '_identification_number' ).val() );
            formData.append( 'date_of_birth', $( kyce + '_date_of_birth' ).val() );
            formData.append( 'address', $( kyce + '_address' ).val() );
            formData.append( 'beneficiary_fullname', $( kyce + '_beneficiary_fullname' ).val() );
            formData.append( 'beneficiary_identification_number', $( kyce + '_beneficiary_identification_number' ).val() );
            formData.append( 'contact_number', $( kyce + '_contact_number' ).val() );
        ...
        let bankSelect2 = $( kyce + '_bank').select2({
        ...
        $( kyce + '_submit' ).click( function() {
            ...
            let formData = new FormData();
            formData.append( 'id', $( kyce + '_kyc' ).val() );
            formData.append( 'fullname', $( kyce + '_fullname' ).val() );
            formData.append( 'identification_number', $( kyce + '_identification_number' ).val() );
            formData.append( 'date_of_birth', $( kyce + '_date_of_birth' ).val() );
            formData.append( 'address', $( kyce + '_address' ).val() );
            ...
            formData.append( 'beneficiary_identification_number', $( kyce + '_beneficiary_identification_number' ).val() );
            formData.append( 'contact_number', $( kyce + '_contact_number' ).val() );
            formData.append( 'bank', $( kyce + '_bank' ).val() );
            formData.append( 'account_holder_name', $( kyce + '_account_holder_name' ).val() );
            formData.append( 'account_number', $( kyce + '_account_number' ).val() );
            formData.append( 'ic_front', fileID );
            // formData.append( 'ic_back', fileID2 );
            formData.append( '_token', '{{ csrf_token() }}' );

            $.ajax( {
                url: '{{ route( 'web.kyc.updateMemberKyc' ) }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
