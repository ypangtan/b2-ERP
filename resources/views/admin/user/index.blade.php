            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function( data, type, row, meta ) {
                        ...
                        let img = row.user_detail?.photo ? row.user_detail.photo_path : 'https://ui-avatars.com/api/?length=1&background=99b0ff&color=fff&name=' + fullname;
                ...
                {
                    targets: parseInt( '{{ Helper::columnIndex( $columns, "kyc_status" ) }}' ),
                    orderable: false,
                    render: function( data, type, row, meta ) {
                        ...
                        return '<span class="' + kycStatusMapper[data.status].color + '">' + kycStatusMapper[data.status].text + '</span>';
                    },
                },
                {
