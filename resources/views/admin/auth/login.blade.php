                                    ...
                                    <form method="POST" action="{{ route('admin.login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="password-wrapper">
                                                <input id="password" class="form-control form-control-sm @error('password') is-invalid @enderror" type="password" name="password" placeholder="{{ __( 'auth.enter_your_x', [ 'type' => strtolower( __( 'auth.password' ) ) ] ) }}" />
