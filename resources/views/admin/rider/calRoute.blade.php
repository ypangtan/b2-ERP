...
<html lang="en">
  <head>
    ...
    <link href="{{ asset( 'admin/css/route.map.css' ) . Helper::assetVersion() }}" rel="stylesheet" />
  ...
  <body>
    ...
    <script src="{{ asset( 'admin/js/route.map.js' ) . Helper::assetVersion() }}"></script>
    <script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA4NOvmOrbvQsORoBew2RO9drpvwrXVJh8&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v2_c" async defer></script>
  </body>
</html>