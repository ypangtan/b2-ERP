...
class Helper {
    ...
    public static function trxTypes() {
        ...
        return [            
            ...
            // '4' => __( 'wallet.transfer_to' ),
            // '5' => __( 'wallet.transfer_from' ),
            '6' => __( 'wallet.convert_to' ),
            '7' => __( 'wallet.convert_from' ),
            '8' => __( 'wallet.purchase_package' ),
            '20' => __( 'wallet.total_rebate' ),
            '21' => __( 'wallet.direct_bonus' ),
            '22' => __( 'wallet.management_bonus' ),
            '23' => __( 'wallet.same_rank_bonus' ),
            '24' => __( 'wallet.company_buy_back' ),
        ];
    }
    ...
    public static function requestOtp( $action, $data = [] ) {
        ...
        if ( $action == 'register' ) {
            ...
            $body = 'Your OTP for JDG ' . $action . ' is ' . $createOtp->otp_code;
            ...
            $body = 'Your OTP for JDG forgot password is ' . $createOtp->otp_code;
