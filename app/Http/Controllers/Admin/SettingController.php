...
class SettingController extends Controller {
    ...
    public function index() {
        ...
        $this->data['data']['banks'] = BankService::banks();
    ...
    public function updateDepositBankDetail( Request $request ) {

        return SettingService::updateDepositBankDetail( $request );
    }

    public function updateWithdrawalSetting( Request $request ) {

        return SettingService::updateWithdrawalSetting( $request );
    }
